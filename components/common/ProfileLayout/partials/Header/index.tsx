					...
					<div className="main-header">
						<div className="header-left">
							<div className="header-logo">
								<Link className="d-flex" href="/">
									<img alt="jobBox" src="/dashboard-assets/imgs/page/dashboard/logo.svg" />
								</Link>
							</div>
						...
						<div className="header-right">
							<div className="block-signin">
								<Link className="btn btn-default icon-edit hover-up" href="/post-job">
									Post Job
								</Link>
								...
								<div className="member-login">
									<img alt="" src="/dashboard-assets/imgs/page/dashboard/profile.png" />
									<div className="info-member">
										<strong className="color-brand-1">Steven Jobs</strong>
										<Menu as="div" className="dropdown">
											<Menu.Button as="a" className="font-xs color-text-paragraph-2 icon-down">
												Super Admin
											</Menu.Button>
											<Menu.Items as="ul" className="dropdown-menu dropdown-menu-light dropdown-menu-end show" style={{ right: '0', left: 'auto' }}>
												<li>
