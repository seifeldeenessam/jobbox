							...
							<div className="panel-white">
								...
								<div className="panel-body">
									...
									<div className="card-style-2 hover-up">
										<div className="card-head">
											<div className="card-image">
												<img src="/dashboard-assets/imgs/page/dashboard/img2.png" alt="jobBox" />
											</div>
											<div className="card-title">
												<h6>Senior Full Stack Engineer, Creator Success</h6>
												<span className="job-type">Full time</span>
									...
									<div className="card-style-2 hover-up">
										<div className="card-head">
											<div className="card-image">
												<img src="/dashboard-assets/imgs/page/dashboard/img3.png" alt="jobBox" />
											</div>
											<div className="card-title">
									...
									<div className="card-style-2 hover-up">
										<div className="card-head">
											<div className="card-image">
												<img src="/dashboard-assets/imgs/page/dashboard/img4.png" alt="jobBox" />
											</div>
											<div className="card-title">
									...
									<div className="card-style-2 hover-up">
										<div className="card-head">
											<div className="card-image">
												<img src="/dashboard-assets/imgs/page/dashboard/img5.png" alt="jobBox" />
											</div>
											<div className="card-title">
						...
						<div className="container">
							<div className="panel-white">
								...
								<div className="panel-body">
									...
									<div className="card-style-3 hover-up">
										<div className="card-image online">
											<img src="/dashboard-assets/imgs/page/dashboard/avata2.png" alt="jobBox" />
										</div>
										<div className="card-title">
											<h6>Cody Fisher</h6>
									...
									<div className="card-style-3 hover-up">
										<div className="card-image online">
											<img src="/dashboard-assets/imgs/page/dashboard/avata3.png" alt="jobBox" />
										</div>
										<div className="card-title">
											<h6>Jane Cooper</h6>
									...
									<div className="card-style-3 hover-up">
										<div className="card-image online">
											<img src="/dashboard-assets/imgs/page/dashboard/avata4.png" alt="jobBox" />
										</div>
										<div className="card-title">
											<h6>Jerome Bell</h6>
									...
									<div className="card-style-3 hover-up">
										<div className="card-image online">
											<img src="/dashboard-assets/imgs/page/dashboard/avata5.png" alt="jobBox" />
										</div>
										<div className="card-title">
											<h6>Floyd Miles</h6>
