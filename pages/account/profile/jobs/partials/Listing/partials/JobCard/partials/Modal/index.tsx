...
export default function Modal({ modalToggle, handleModal }: Props) {
	return (
		<>
			<div className={`modal fade ${modalToggle ? 'show' : ''}`} style={modalToggle ? { paddingRight: 17, display: 'block' } : undefined}>
						...
						<div className="modal-body pl-30 pr-30 pt-50">
							...
							<form className="login-register text-start mt-20 pb-30" action="#">
								...
								<div className="login_footer form-group d-flex justify-content-between">
									...
									<Link className="text-muted" href="/page-contact">
										Lean more
									</Link>
								</div>
								<div className="form-group">
								...
								<div className="text-muted text-center">
									Do you need support? <Link href="/page-contact">Contact Us</Link>
								</div>
							</form>
						</div>
					</div>
