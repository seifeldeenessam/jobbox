									...
									<div className="col-lg-7 col-md-12 col-sm-12">
										<div className="pt-40 pb-30 pl-30 pr-30">
											...
											<p className="font-md mb-20">
												Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam laoreet rutrum quam, id faucibus erat interdum a. Curabitur eget tortor a nulla
												interdum semper. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam laoreet rutrum quam, id faucibus erat interdum a. Curabitur eget
												tortor a nulla interdum semper.
											</p>
											<div>
												<Link legacyBehavior href="blog-details">
												...
												<div className="card-grid-3 hover-up">
													...
													<div className="card-block-info">
														...
														<p className="mt-10 color-text-paragraph font-sm">
															Our mission is to create the world&amp;rsquo;s most sustainable healthcare company by creating high-quality healthcare products in iconic,
