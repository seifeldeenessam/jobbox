...
const RecruitersPage: NextPage<PublicPageProps> = ({ session }) => {
												...
												<div className="list-checkbox pb-20">
													<div className="row position-relative mt-10 mb-20">
														...
														<div className="box-input-money">
															<input className="input-disabled form-control min-value-money" type="text" name="min-value-money" disabled defaultValue="" />
