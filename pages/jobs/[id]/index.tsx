...
const JobsDetailsPage: NextPage<PublicPageProps> = ({ session }) => {
								...
								<div className="col-lg-8 col-md-12 col-sm-12 col-12">
									<div className="box-border-single">
										...
										<div className="content-single">
											...
											<p>
												<strong>Communication:</strong> Communicate the results of UX activities within your product area to the design team department, cross-functional
												partners within your product area, and other interested Superformula team members using clear language that simplifies complexity.
											</p>
										</div>
