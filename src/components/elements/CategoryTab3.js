				...
				<ul className="nav nav-tabs" role="tablist">
					<li>
						<a className={active === 1 ? 'active' : ''} onClick={() => handleOnClick(1)}>
							<img src="/app-assets/imgs/page/homepage1/management.svg" alt="jobBox" /> Management
						</a>
					</li>
					<li>
						<a className={active === 2 ? 'active' : ''} onClick={() => handleOnClick(2)}>
							<img src="/app-assets/imgs/page/homepage1/marketing.svg" alt="jobBox" /> Marketing &amp; Sale
						</a>
					</li>
					<li>
						<a className={active === 3 ? 'active' : ''} onClick={() => handleOnClick(3)}>
							<img src="/app-assets/imgs/page/homepage1/finance.svg" alt="jobBox" /> Finance
						</a>
					</li>
					<li>
						<a className={active === 4 ? 'active' : ''} onClick={() => handleOnClick(4)}>
							<img src="/app-assets/imgs/page/homepage1/human.svg" alt="jobBox" /> Human Resource
						</a>
					</li>
					<li>
						<a className={active === 5 ? 'active' : ''} onClick={() => handleOnClick(5)}>
							<img src="/app-assets/imgs/page/homepage1/retail.svg" alt="jobBox" /> Retail &amp; Products
						</a>
					</li>
					<li>
						<a className={active === 6 ? 'active' : ''} onClick={() => handleOnClick(6)}>
							<img src="/app-assets/imgs/page/homepage1/content.svg" alt="jobBox" /> Content Writer
						</a>
					</li>
				</ul>
			</div>
